...
<section class="hero">
	<img class="img-responsive" src="design/images/vendors/hero.jpg" alt="hero" />
</section>
<!--
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				...
				<p class="lead">This happens every sunday for 10 weeks from <strong>January the 26th</strong> to <strong>February the 23rd</strong>. 
				<p>The stalls will be set up in Caulfield Racecourse's main entertainment area which holds enough room for over 60 vendors and numerous food trucks. 5000+ people are to attend weekly with demonstrations from past Masterchef contestants, not to mention world-class musical and dance performers which are sure to add to the numbers.</p>
				...
				<p><a href="design/images/vendor.pdf" target="_blank" class="btn btn-large btn-primary">Download the Vendor Pack</a> <a href="http://goo.gl/qDdB7x" class="btn btn-info btn-large" target="_blank">Express your interest</a></p>
			</div>
			<div class="col-sm-6">
				<ul class="pricing list-unstyled">
					<li class="item">
						<span class="title">Standard Stall</span>
						<ul class="list-inline">
							<li>3x3m stall</li>
							<li>$1380 deposit</li>
							<li class="pull-right">
								<span class="cost">
									<span class="dollar">$</span>690
					...
					<li class="item">
						<span class="title">Large Stall</span>
						<ul class="list-inline">
							<li>3x6m stall</li>
							<li>$1760 deposit</li>
							<li class="pull-right">
								<span class="cost">
									<span class="dollar">$</span>790
									<small>per week</small>
								</span>
							</li>
						</ul>
					...
					<li class="item">
						<span class="title">Standard + Drinks</span>
						<ul class="list-inline">
							<li>3x3 stall</li>
							<li>$1760 deposit</li>
							<li>+100 if large stall</li>
							<li class="pull-right">
								<span class="cost">
									<span class="dollar">$</span>790
									<small>per week</small>
					...
					<li class="item">
						<span class="title">Drinks only</span>
						<ul class="list-inline">
							<li>3x3 stall</li>
							<li>$500 deposit</li>
					...
					<li class="item">
						<span class="title">Food truck</span>
						<ul class="list-inline">
							<li>Foodtruck area</li>
							<li>$1000 deposit</li>
							<li class="pull-right">
								<span class="cost">
									<span class="dollar">$</span>500
